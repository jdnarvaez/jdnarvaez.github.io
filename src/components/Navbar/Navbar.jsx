...
export const NavItem = ({ children, idx, isActive, onClick }) => {
  ...
  return (
    <motion.div variants={item}>
      <motion.div
        style={{ position: 'relative', display: 'flex', fontWeight: isActive ? '900' : '700' }}
        initial={false}
      ...
      >
        ...
        <div className={styles.navItemContent}>
          <motion.div onClick={onClick} className={styles.inner}>
            {children}
          </motion.div>
        </div>
      </motion.div>
...
export const Navbar = ({ children, activeItem }) => {
  ...
  return (
    <motion.div className={styles.navbar}>
      ...
      />
      <motion.div className={styles.navbarList} initial="hidden" animate="visible" variants={list}>
        {children}
      </motion.div>
