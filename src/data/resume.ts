...
export const experience: TimelineEntry[] = [
  {
    ...
    highlights: [
      'Designed & developed OASIS OneLink, a modular real-time C2 (Command + Control) Application Platform',
      ...
      'Zero-trust device enrollment framework used in offline-first environments',
      'Google Earth Pro style GIS tooling w/ import / export of KML / KMZ + 3D models',
      ...
      'MGRS overlay layers',
      'Countour tile overlay layers',
      'WebGL based LIDAR map overlay layers',
      ...
      'GitLab CI Pipelines + environment deployment + management',
